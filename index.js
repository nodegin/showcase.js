...
(function() {
  ...
  (function(glob, factory) {
    ...
    Showcase.prototype.location = [0, 0];
    ...
    Showcase.prototype.dispose = function() {
      var prod;
      prod = this._product;
      return prod.fadeOut(150, (function(_this) {
        return function() {
          return _this.remove() && (prod = null);
        };
      })(this));
    };
    ...
    Showcase.prototype.build = function() {
      var blockBottom, blockLeft, blockRight, blockTop, button, buttonWrapper, cling, clipper, clipperContainer, heightLoaded, textContent, widthLoaded, _ref, _ref1;
      ...
      _ref = this.buildBlocks(), blockLeft = _ref[0], blockTop = _ref[1], blockRight = _ref[2], blockBottom = _ref[3];
      ...
      _ref1 = [window.innerWidth, window.innerHeight], widthLoaded = _ref1[0], heightLoaded = _ref1[1];
